...
void settings::loadSettings()
{
    ...
    label_12->setText(set.value("TextEdit\HTC", QColor(Qt::white)).toString());
	//---背光 - 文字
    label_14->setText(set.value("Highlighter\ColorOfLocationFormat", QColor(Qt::darkYellow)).toString());
    label_16->setText(set.value("Highlighter\ColorOfObjectFormat", QColor(Qt::blue)).toString());
    label_18->setText(set.value("Highlighter\ColorOfFunctionFormat", QColor(Qt::darkRed)).toString());
    label_20->setText(set.value("Highlighter\ColorOfClassesFormat", QColor(Qt::darkCyan)).toString());
    label_22->setText(set.value("Highlighter\ColorOfValuesFormat", QColor(Qt::blue)).toString());
    label_24->setText(set.value("Highlighter\ColorOfPseudoStatesFormat", QColor(Qt::darkMagenta)).toString());
    label_26->setText(set.value("Highlighter\ColorOfSubControlsFormat", QColor(Qt::darkRed)).toString());
	label_28->setText(set.value("Highlighter\ColorOfColorsFormat", QColor::fromRgb(85, 170, 255)).toString());
    label_30->setText(set.value("Highlighter\ColorOfCommentFormat", QColor(Qt::red)).toString());
	//---背光颜色
    colorOfLocation.setNamedColor(set.value("Highlighter\ColorOfLocationFormat", QColor(Qt::darkYellow)).toString());
    colorOfObject.setNamedColor(set.value("Highlighter\ColorOfObjectFormat", QColor(Qt::blue)).toString());
    colorOfFunction.setNamedColor(set.value("Highlighter\ColorOfFunctionFormat", QColor(Qt::darkRed)).toString());
    colorOfClasses.setNamedColor(set.value("Highlighter\ColorOfClassesFormat", QColor(Qt::darkCyan)).toString());
    colorOfValues.setNamedColor(set.value("Highlighter\ColorOfValuesFormat", QColor(Qt::blue)).toString());
    colorOfPseudoStates.setNamedColor(set.value("Highlighter\ColorOfPseudoStatesFormat", QColor(Qt::darkMagenta)).toString());
    colorOfSubControls.setNamedColor(set.value("Highlighter\ColorOfSubControlsFormat", QColor(Qt::darkRed)).toString());
	colorOfColors.setNamedColor(set.value("Highlighter\ColorOfColorsFormat", QColor::fromRgb(85, 170, 255)).toString());
    colorOfComment.setNamedColor(set.value("Highlighter\ColorOfCommentFormat", QColor(Qt::red)).toString());
	//调色板
